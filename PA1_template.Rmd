...
## Make a histogram of the total number of steps taken each day
```{r Total number of steps taken each day with missing data filled}
...
The new mean and median are `r as.integer(mean_total_filled)` and `r as.integer(median_total_filled)`.
...
```{r Averaged number of steps taken accross all weekday or weekend day}
